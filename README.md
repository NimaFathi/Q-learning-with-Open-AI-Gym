...
In this Repo my purpose was to dive into Reinforcment Learning.<br>
...
# 1- Taxi-v2:
Taxi-v2 is a problem with discrete state and action spaces so that is perfect match for Q-learning.
